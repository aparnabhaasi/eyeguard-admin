...
if(isset($_POST['submit'])){
	$search = $_POST['search'];
	$q="SELECT * FROM `product` where category='kid' and  product like '%$search%'";
}
else{
...
?>
    ...
    <a href="publicsingle.php?id=<?php echo $id;?>&cat=<?php echo $cat;?>" class="link-product-add-cart">Quick View</a>
</div>
<script>
