...
$category = isset($_GET['product']) ? $_GET['product'] : '';
$frameType = isset($_GET['frameType']) ? $_GET['frameType'] : '';

// Build the SQL query
$q = "SELECT * FROM `product` WHERE 1";

// Check if a category is specified, and add a WHERE condition accordingly
if (!empty($category)) {
    $q .= " AND product = '$category'";
}

// Check if a frame type is specified, and add a WHERE condition accordingly
if (!empty($frameType)) {
    $q .= " OR frame_type = '$frameType'";
}
															...
															<div class="item-info-product">
																...
																<div class="info-product-price">
																	<div class="grid_meta">
																		<div class="product_price">
																			<h4>
																				<a href="single.php">Fastrack Aviator
																				</a>
																			</h4>
																			<div class="grid-price mt-2">
															...
															<div class="item-info-product">
																...
																<div class="info-product-price">
																	<div class="grid_meta">
																		<div class="product_price">
																			<h4>
																				<a href="single.php">Royal Son Aviator
																				</a>
																			</h4>
																			<div class="grid-price mt-2">
																				<span class="money ">₹425.00</span>
															...
															<div class="item-info-product">
																...
																<div class="info-product-price">
																	<div class="grid_meta">
																		<div class="product_price">
																			<h4>
																				<a href="single.php">Irayz Butterfly
																				</a>
																			</h4>
																			<div class="grid-price mt-2">
															...
															<div class="item-info-product">
																...
																<div class="info-product-price">
																	<div class="grid_meta">
																		<div class="product_price">
																			<h4>
																				<a href="single.php">Jerry Rectangular
																				</a>
																			</h4>
																			<div class="grid-price mt-2">
